...
| 用途 | 项目资源位置 | 建议尺寸 |
|------|--------------|----------|
| 首页浅色首屏 | `source/img/light-bg.webp` | 1920×1440 或更大 |
| 首页深色首屏 | `source/img/dark-bg.webp` | 1920×1440 或更大 |
| 头像 | `source/img/avatar.webp` | 512×512 正方形 |

文章顶部图片由每篇 Markdown 文件单独设置。把图片放入 `source/img/`，然后在文章 Front Matter 中添加：

```yaml
---
title: 示例文章
date: 2026-07-11
top_img: /img/post-cover.webp
---
```

没有填写 `top_img` 时，文章顶部显示主题占位色 `#13213A`。新文章模板 `scaffolds/post.md` 已包含该字段。
